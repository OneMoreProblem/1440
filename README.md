...
| Номер | Задача | Статус |
|-------|--------|--------|
| 0 | Верификация, сверить с существующими библиотеками | ✅ Выполнено |
| 1 | Документация к визуализации | ⏳ Ожидается |
| 2 | Покрытие тестами визуализации | ⏳ Ожидается |
| 3 | Примеры использования визуализации | ✅ Выполнено  |
| 4 | Уточнение для модели прецессии | ✅ Выполнено  |
| 5 | Учет нутеллы | ⏳ Ожидается |
| 6 | Учет движения полюсов | ⏳ Ожидается |
| 7 | Реорганизация порядка подачи аргументов и выводов в соответствии с требованиями из задания | ⏳ Ожидается |
| 8 | Использование в ноутбуке функций из пакета | ⏳ Ожидается |
| 9 | Подумать над уместностью ООП | ⏳ Ожидается |
| 10 | Разобраться с автоматическим тестированием | ✅ Выполнено  |
| 11 | Поправить структуру документа и изложения материала, сделать акцент на жизненный цикл модели | ⏳ Ожидается |
| 12 | Попробуем ECS? Для расширяемости, предположим, что и наблюдателей и КА будет множество, определим структуру сущностей, список компонент для каждой сущности, а потом определим системы обработки компонент и сущностей | ⏳ Ожидается |
